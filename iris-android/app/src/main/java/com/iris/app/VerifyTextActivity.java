...
public class VerifyTextActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IrisApiClient.verifyText(this, text, new IrisApiClient.Callback() {
            ...
            public void onSuccess(String responseJson) {
                ...
                HistoryStore.record(VerifyTextActivity.this, responseJson, text, "text");
    ...
    private View claimPreview(String selectedText) {
        ...
        quote.setBackground(IrisUi.bordered(this, IrisUi.BLUE_BG, 14, IrisUi.BLUE_OUTLINE));
        return quote;
    }
    ...
    private void showError(String message) {
        ...
        if (statusText != null) {
            ...
            statusText.setTextColor(IrisUi.STATUS_ERROR);
        }
